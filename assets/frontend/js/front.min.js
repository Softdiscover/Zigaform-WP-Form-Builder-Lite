 ...
 */
function(t){"function"==typeof define&&define.amd?define(["jquery"],t):"object"==typeof module&&module.exports?t(require("jquery")):t(jQuery)}((function(t){var e,a,r="[object OperaMini]"===Object.prototype.toString.call(window.operamini),i="placeholder"in document.createElement("input")&&!r&&!0,n="placeholder"in document.createElement("textarea")&&!r&&!0,o=t.valHooks,s=t.propHooks,c={};function f(e,a){var r=this,i=t(this);if(r.value===i.attr("placeholder")&&i.hasClass(c.customClass))if(r.value="",i.removeClass(c.customClass),i.data("placeholder-password")){if(i=i.hide().nextAll('input[type="password"]:first').show().attr("id",i.removeAttr("id").data("placeholder-id")),!0===e)return i[0].value=a,a;i.focus()}else r==m()&&r.select()}function l(e){var a,r,i,n,o=this,s=t(this),l=o.id;if(!e||"blur"!==e.type||!s.hasClass(c.customClass))if(""===o.value){if("password"===o.type){if(!s.data("placeholder-textinput")){try{a=s.clone().prop({type:"text"})}catch(e){a=t("<input>").attr(t.extend((r=this,i={},n=/^jQuery\d+$/,t.each(r.attributes,(function(t,e){e.specified&&!n.test(e.name)&&(i[e.name]=e.value)})),i),{type:"text"}))}a.removeAttr("name").data({"placeholder-enabled":!0,"placeholder-password":s,"placeholder-id":l}).bind("focus.placeholder",f),s.data({"placeholder-textinput":a,"placeholder-id":l}).before(a)}o.value="",s=s.removeAttr("id").hide().prevAll('input[type="text"]:first').attr("id",s.data("placeholder-id")).show()}else{var m=s.data("placeholder-password");m&&(m[0].value="",s.attr("id",s.data("placeholder-id")).show().nextAll('input[type="password"]:last').hide().removeAttr("id"))}s.addClass(c.customClass),s[0].value=s.attr("placeholder")}else s.removeClass(c.customClass)}function m(){try{return document.activeElement}catch(t){}}i&&n?((a=t.fn.placeholder=function(){return this}).input=!0,a.textarea=!0):((a=t.fn.placeholder=function(e){return c=t.extend({},{customClass:"placeholder"},e),this.filter((i?"textarea":":input")+"[placeholder]").not("."+c.customClass).not(":radio, :checkbox, [type=hidden]").bind({"focus.placeholder":f,"blur.placeholder":l}).data("placeholder-enabled",!0).trigger("blur.placeholder")}).input=i,a.textarea=n,e={get:function(e){var a=t(e),r=a.data("placeholder-password");return r?r[0].value:a.data("placeholder-enabled")&&a.hasClass(c.customClass)?"":e.value},set:function(e,a){var r,i,n=t(e);return""!==a&&(r=n.data("placeholder-textinput"),i=n.data("placeholder-password"),r?(f.call(r[0],!0,a)||(e.value=a),r[0].value=a):i&&(f.call(e,!0,a)||(i[0].value=a),e.value=a)),n.data("placeholder-enabled")?(""===a?(e.value=a,e!=m()&&l.call(e)):(n.hasClass(c.customClass)&&f.call(e),e.value=a),n):(e.value=a,n)}},i||(o.input=e,s.value=e),n||(o.textarea=e,s.value=e),t((function(){t(document).delegate("form","submit.placeholder",(function(){var e=t("."+c.customClass,this).each((function(){f.call(this,!0,"")}));setTimeout((function(){e.each(l)}),10)}))})),t(window).bind("beforeunload.placeholder",(function(){var e=!0;try{"javascript:void(0)"===document.activeElement.toString()&&(e=!1)}catch(t){}e&&t("."+c.customClass).each((function(){this.value=""}))})))}));