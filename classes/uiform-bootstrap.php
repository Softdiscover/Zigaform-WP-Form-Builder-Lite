...
JS;
    ...
    public function get_menu(){
        ...
        switch ($current_page) 
		{
                case 'zgfm_form_builder': $this->route_page(); break;
                case 'zigaform-builder-help':	include(dirname(__DIR__) . '/views/help/help.php');			break;
    ...
    public static function load_admin_resources() {
        ...
        /*wp_register_script(
         ...
         if(UIFORM_DEV===1){
            ...
            //iframe
            wp_enqueue_script('rockefform-iframe', UIFORM_FORMS_URL . '/assets/frontend/js/iframe/3.5.11/iframeResizer.min.js', array(),UIFORM_VERSION,true);
