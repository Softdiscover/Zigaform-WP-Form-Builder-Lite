    ...
    public function zigaform_upgrade()
    {
        ...
        if ( 'new' == $install_type) {
            if ( ZIGAFORM_F_LITE) {
                ...
                $notice_url     = 'https://shop.softdiscover.com/downloads/zigaform-wordpress-form-builder/?utm_source=installed&utm_medium=referral';
                $notice_heading = esc_html__('Thanks for installing Zigaform. We hope you like it!', 'FRocket_admin');
                $notice_content = esc_html__('And hey, if you do, give it a 5-star rating to help us spread the word and boost our motivation.', 'FRocket_admin');
                $button_content = esc_html__('Go Zigaform Pro', 'FRocket_admin');
            }
        } else {
            if ( ZIGAFORM_F_LITE) {
...
JS;
    ...
    public function get_extra_meta_links($meta, $file, $data, $status)
    {
        ...
        if ( $pos_coincidencia !== false) {
            ...
            if ( ZIGAFORM_F_LITE === 1) {
                $meta[] = "<a href='https://shop.softdiscover.com/downloads/zigaform-wordpress-form-builder/' target='_blank'><span class='dashicons  dashicons-cart'></span>" . __('Get Premium', 'FRocket_admin') . '</a>';
            ...
            if ( ZIGAFORM_F_LITE === 1) {
                ...
                $meta[] = "<a href='https://shop.softdiscover.com/downloads/zigaform-wordpress-form-builder/?utm_source=installed&utm_medium=referral' target='_blank' title='" . __('Leave a review', 'FRocket_admin') . "'><i class='ml-stars'><svg xmlns='http://www.w3.org/2000/svg' width='15' height='15' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-star'><polygon points='12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2'/></svg><svg xmlns='http://www.w3.org/2000/svg' width='15' height='15' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-star'><polygon points='12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2'/></svg><svg xmlns='http://www.w3.org/2000/svg' width='15' height='15' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-star'><polygon points='12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2'/></svg><svg xmlns='http://www.w3.org/2000/svg' width='15' height='15' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-star'><polygon points='12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2'/></svg><svg xmlns='http://www.w3.org/2000/svg' width='15' height='15' viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' class='feather feather-star'><polygon points='12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2'/></svg></i></a>";
            }
        }
