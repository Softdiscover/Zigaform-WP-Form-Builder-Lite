              ...
              <fieldset>
                <?php if (ZIGAFORM_F_LITE === 1) { ?>
                  <div class="form-group">
                    <a href="https://wordpress.org/support/plugin/zigaform-form-builder-lite/reviews/?filter=5#new-post" target="_blank">
                    ...
                    <div id="zgfm-page-about-leavestars">
                      <a href="https://wordpress.org/support/plugin/zigaform-form-builder-lite/reviews/?filter=5#new-post" target="_blank"><?php echo __('Leave 5 Stars', 'FRocket_admin'); ?></a>
                    </div>
                  </div>
                <?php } else { ?>
                  <div class="form-group">
                    <a href="https://shop.softdiscover.com/downloads/zigaform-wordpress-form-builder/?utm_source=installed&utm_medium=referral" target="_blank">
                      <img id="zgfm-page-about-rate-icon" src="<?php echo UIFORM_FORMS_URL; ?>/assets/backend/image/about/zigaform-rate-icon.png">
                    </a>
                    <div id="zgfm-page-about-leavestars">
                      <a href="https://shop.softdiscover.com/downloads/zigaform-wordpress-form-builder/" target="_blank"><?php echo __('Leave 5 Stars', 'FRocket_admin'); ?></a>
                    </div>
                  </div>
                <?php } ?>
