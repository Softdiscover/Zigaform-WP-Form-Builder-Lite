...
<div class="table-responsive">
					...
					<thead>
						<tr>
							...
							<th><?php echo __( 'Record Form', 'FRocket_admin' ); ?></th>
						...
						<tr>
							<th>
								<input type="checkbox"
									   ...
									   value="<?php echo $row->fbh_id; ?>"
									   name="id[]"
									   >
							</th>
							<td><?php echo $row->fbh_id; ?></td>
							...
							<td>
								<div class="sfdc-btn-group">
								 <?php echo $obj_list_data->list_detail_trashrecord_buttons($row->fbh_id);?>
								</div>
							</td>
						</tr>
								<?php
