...
<div class="uiform-listform-options-col">
						 <a class="sfdc-btn sfdc-btn-sm sfdc-btn-warning uiform-confirmation-func-action" 
							...
							data-dialog-callback="zgfm_back_general.list_records_updateStatus(2);"
					...
					<div class="uiform-listform-options-col">
						 <a class="sfdc-btn sfdc-btn-sm sfdc-btn-info uiform-confirmation-func-action" 
							...
							data-dialog-callback="zgfm_back_general.list_records_updateStatus(1);"
						href="javascript:void(0);">
					...
					<div class="uiform-listform-options-col">
						<a class="sfdc-btn sfdc-btn-sm sfdc-btn-danger uiform-confirmation-func-action" 
						   data-dialog-title="<?php echo __( 'Remove permanently', 'FRocket_admin' ); ?>"
						   data-dialog-callback="zgfm_back_general.list_records_updateStatus(0);"
						href="javascript:void(0);">
							<i class="fa fa-trash-o"></i>
						<?php echo __( 'Remove permanently', 'FRocket_admin' ); ?>
						</a>
					</div>