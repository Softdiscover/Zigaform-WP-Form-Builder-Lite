...
<div class='sfdc-wrap'>
    ...
    <div id="zgfm-modal-calc-container">
            <div class="sfdc-alert sfdc-alert-info">
                <strong><?php echo __('Info!', 'FRocket_admin'); ?></strong> <?php echo __('Choose your variable. Under Backend tab, you will find variables to be used in mail notification or Submission message', 'FRocket_admin'); ?>
              </div>
