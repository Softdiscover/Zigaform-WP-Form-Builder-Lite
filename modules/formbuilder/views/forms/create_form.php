  ...
  <div class="uiform-editing-dashboard">
    ...
    <div class="uiformc-menu-wrap">
      <ul class="sfdc-nav sfdc-nav-tabs">
        ...
        <li class="<?php if ($is_multistep !== 'yes') { ?>sfdc-active<?php } ?>">
    ...
    <div class="sfdc-tab-content">
      ...
      <?php } ?>
      <div id="uiformc-menu-sec1" class="sfdc-tab-pane <?php if ($is_multistep !== 'yes') { ?> sfdc-in sfdc-active<?php } ?> <?php if ($is_multistep === 'yes') { ?>zgfm_mulstistep_mode<?php } ?> ">
        <!-- editing form -->
